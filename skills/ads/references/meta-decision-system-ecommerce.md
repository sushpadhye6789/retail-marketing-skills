...
**For the dedicated catalog-driven campaign type (Advantage+ Shopping Campaigns) specifically** — combining prospecting and retargeting into one automated campaign, product-set segmentation, and when to opt out of it in favor of manual structure — see [advantage-plus-shopping-ecommerce.md](advantage-plus-shopping-ecommerce.md). This section covers the general manual-to-Advantage+ transition; that file covers the ecommerce-specific catalog campaign built on top of it.
