...
| `marketing-plan` | Its retail-funnel planning methodology (Awareness, Consideration, Conversion, Loyalty) applies well to B2B/wholesale planning; most useful for planning the wholesale side specifically, alongside (not instead of) the consumer-facing plan | Both |
