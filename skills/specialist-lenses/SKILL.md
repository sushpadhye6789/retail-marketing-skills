...
5. **If no specialist here fits**, say so — don't force-fit the nearest one.

## Current Roster

39 specialists across 12 domains. Two names from the original candidate list — **April Dunford** and **Ann Handley** — already have deeper, independently-researched dossiers in `marketing-council/references/advisors/`; go there instead of expecting a duplicate here.

### Brand & Strategy
| Specialist | Domain | File |
|---|---|---|
| Mark Ritson | Brand strategy — 60/40 brand-build vs. activation | [mark-ritson.md](references/specialists/mark-ritson.md) |
| Bozoma Saint John | Cultural-moment brand storytelling | [bozoma-saint-john.md](references/specialists/bozoma-saint-john.md) |
| Jonah Berger | Viral mechanics — STEPPS | [jonah-berger.md](references/specialists/jonah-berger.md) |
| Joey Coleman | Post-sale CX — First 100 Days | [joey-coleman.md](references/specialists/joey-coleman.md) |

### B2B & Content Strategy
| Specialist | Domain | File |
|---|---|---|
| Ross Simmonds | Content distribution — Create Once, Distribute Forever | [ross-simmonds.md](references/specialists/ross-simmonds.md) |
| Sangram Vajre | Account-based marketing — T.E.A.M. | [sangram-vajre.md](references/specialists/sangram-vajre.md) |
| Marcus Andrews | Product marketing narrative design | [marcus-andrews.md](references/specialists/marcus-andrews.md) |
| Joanna Wiebe | Conversion copywriting | [joanna-wiebe.md](references/specialists/joanna-wiebe.md) |

### Performance & Acquisition
| Specialist | Domain | File |
|---|---|---|
| Chris Walker | Demand creation vs. demand capture | [chris-walker.md](references/specialists/chris-walker.md) |
| Talia Wolf | CRO — emotional targeting | [talia-wolf.md](references/specialists/talia-wolf.md) |
| Kasim Aslam | Paid search — Performance Max | [kasim-aslam.md](references/specialists/kasim-aslam.md) |
| Thomas Petit | Mobile growth / ASO | [thomas-petit.md](references/specialists/thomas-petit.md) |

### SEO, AI & Intelligence
| Specialist | Domain | File |
|---|---|---|
| Rand Fishkin | Audience intelligence / zero-click search | [rand-fishkin.md](references/specialists/rand-fishkin.md) |
| Aleyda Solis | Technical & international SEO for AI search | [aleyda-solis.md](references/specialists/aleyda-solis.md) |
| Kevin Indig | AI search visibility (GEO) | [kevin-indig.md](references/specialists/kevin-indig.md) |
| Christopher S. Penn | AI task-selection & data-quality discipline | [christopher-penn.md](references/specialists/christopher-penn.md) |
| Mike King | AI retrieval — Relevance Engineering / query fan-out | [mike-king.md](references/specialists/mike-king.md) |
| Paul Roetzer | AI adoption strategy — AI Marketing Canvas | [paul-roetzer.md](references/specialists/paul-roetzer.md) |
| Julia McCoy | AI content editing — CRAFT | [julia-mccoy.md](references/specialists/julia-mccoy.md) |
| Justine Moore | Generative video / creative trends | [justine-moore.md](references/specialists/justine-moore.md) |
| Kartik Hosanagar | Algorithmic personalization research | [kartik-hosanagar.md](references/specialists/kartik-hosanagar.md) |

### MarTech & Systems
| Specialist | Domain | File |
|---|---|---|
| Scott Brinker | Martech platform ecosystem strategy | [scott-brinker.md](references/specialists/scott-brinker.md) |
| Lenny Rachitsky | Product-led growth / channel fit | [lenny-rachitsky.md](references/specialists/lenny-rachitsky.md) |
| Chad S. White | Email deliverability & lifecycle | [chad-white.md](references/specialists/chad-white.md) |
| Daniel Cmejla | Community-led growth as moat | [daniel-cmejla.md](references/specialists/daniel-cmejla.md) |
| Avinash Kaushik | Web analytics — Web Analytics 2.0 | [avinash-kaushik.md](references/specialists/avinash-kaushik.md) |
| Gini Dietrich | Integrated PR — PESO Model | [gini-dietrich.md](references/specialists/gini-dietrich.md) |

### Social & Influencer
| Specialist | Domain | File |
|---|---|---|
| Brendan Gahan | Platform-native social strategy | [brendan-gahan.md](references/specialists/brendan-gahan.md) |
| Lindsey Gamble | Creator economy infrastructure trends | [lindsey-gamble.md](references/specialists/lindsey-gamble.md) |
| Jon Youshaei | Creator partnership evaluation & negotiation | [jon-youshaei.md](references/specialists/jon-youshaei.md) |

### E-Commerce & Retail
| Specialist | Domain | File |
|---|---|---|
| Taylor Holiday | DTC unit economics — contribution margin | [taylor-holiday.md](references/specialists/taylor-holiday.md) |
| Jason Goldberg | Omnichannel friction removal | [jason-goldberg.md](references/specialists/jason-goldberg.md) |
| Elizabeth Marsten | Retail media portfolio strategy | [elizabeth-marsten.md](references/specialists/elizabeth-marsten.md) |
| Eli Weiss (with Val Geisler) | Post-purchase retention / CX | [eli-weiss.md](references/specialists/eli-weiss.md) |
| Savannah Sanchez | Native UGC ad creative | [savannah-sanchez.md](references/specialists/savannah-sanchez.md) |
| Steven Pope | Amazon PPC — the ranking flywheel | [steven-pope.md](references/specialists/steven-pope.md) |

### Loyalty, Data & AI Ads *(not in the original master directory — added from earlier conversation)*
| Specialist | Domain | File |
|---|---|---|
| Adam Posner | Loyalty program differentiation | [adam-posner.md](references/specialists/adam-posner.md) |
| Simo Ahava | Tag management / server-side tracking | [simo-ahava.md](references/specialists/simo-ahava.md) |
| Mike Rhodes | AI-assisted Google Ads practice | [mike-rhodes.md](references/specialists/mike-rhodes.md) |

Several entries flag lower research confidence than others — see `daniel-cmejla.md`, `lenny-rachitsky.md`, and `eli-weiss.md` specifically, where a framework name in the original candidate list wasn't independently confirmed and the file says so rather than asserting it.
...
2. Research their public output (talks, free posts, interviews) rather than relying on general familiarity — same discipline used to build the current roster.
